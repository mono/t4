...
namespace Mono.TextTemplating.Tests
{
	...
	public class FileUtilTest
	{
		...
		{
			Assert.AreEqual( "something.txt", FileUtil.AbsoluteToRelativePathUnsafe( "C:\\temp", "C:\\temp\\something.txt" ), "FileUtilTest" );
			Assert.AreEqual( "temp\\something.txt", FileUtil.AbsoluteToRelativePathUnsafe( "C:\\", "C:\\temp\\something.txt" ), "FileUtilTest" );
			Assert.AreEqual( "temp\\subfolder\\something.txt", FileUtil.AbsoluteToRelativePathUnsafe( "C:\\", "C:\\temp\\subfolder\\something.txt" ), "FileUtilTest" );
			Assert.AreEqual( "something.txt", FileUtil.AbsoluteToRelativePathUnsafe( "C:\\temp\\subfolder", "C:\\temp\\subfolder\\something.txt" ), "FileUtilTest" );
